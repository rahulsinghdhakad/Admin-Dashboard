...
const img2= "https://encrypted-tbn0.gstatic.com/shopping?q=tbn:ANd9GcTSLduuoAs4usikB87tK5Ppk8r8Mk03QrDx7vk32wQQPRX6HAnpkt7peGkxq1y1TrJHXChfdL6mCk3b1DTh_VbrlbWkNKm6pcWHR5Pdb-glExOlVRyCRjujkGjPwoxj5huaMQuA5qg&usqp=CAc"

const arr: DataType[] = [
  {
    photo:<img src={img} alt="shoe"/>,
    name: "Puma Shoe",
    price: 2300,
    stock: 15,
    action: <Link to={"sdfasdf"}>Manage</Link>,
  },
  {
    photo:<img src={img2} alt="shoe"/>,
    name: "Macbook M1",
    price: 15500,
    stock: 10,
    action: <Link to={"asdfadf"}>Manage</Link>,
  },
...
const Product = () => {
  ...
  return (
    <div className="adminContainer">
      ...
      <main>
        {Table()}
        <Link to={"/admin/product/new"} className="product-link">
          <FaPlus/>
        </Link>
      </main>
    </div>
